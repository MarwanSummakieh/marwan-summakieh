...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative h-[60vh] w-screen flex flex-col items-center justify-center overflow-hidden bg-black-100 rounded-md z-0",
                className
            )}
        >
            <div className="relative flex w-full flex-1 items-center justify-center isolate z-0 ">
                ...
                <div className="absolute inset-auto z-50 h-36 w-[20rem] md:w-[28rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
                <motion.div
                    initial={{ width: "6rem" }}
