...
// We'll define a base transition object and then apply a delay for each path
const BASE_TRANSITION = {
  duration: 4, // total cycle time, e.g. 4 seconds
  ease: "linear",
  repeat: Infinity,
};

// Define the five paths and their stroke colors
const PATHS = [
  {
